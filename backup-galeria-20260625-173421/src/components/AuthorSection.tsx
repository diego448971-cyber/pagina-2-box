    ...
    <MotionSection className="bg-white">
      <div className="container-shell grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
        <ResponsiveImage
          ...
          src="/images/foto-autor-diego.png"
        />
        <div>
          <SectionTitle
            align="left"
            ...
            description="Diego dos Santos Lima é o autor dos materiais deste Box, criado para apresentar informações organizadas, caminhos práticos e possibilidades de renda extra e prestação de serviços."
          />
          <p className="mt-5 text-base leading-7 text-graphite">
            A proposta do conteúdo é oferecer uma leitura simples e objetiva, ajudando o leitor a refletir sobre sua rotina, suas habilidades e formas de começar com mais organização e responsabilidade.
          </p>
