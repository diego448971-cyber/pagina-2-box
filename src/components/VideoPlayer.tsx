...
export default function VideoPlayer({ youtubeVideoId, localVideoSrc, poster }: VideoPlayerProps) {
    ...
    return (
      <div className="aspect-video overflow-hidden rounded-lg bg-black shadow-premium">
        <iframe
          ...
          title="Vídeo de apresentação do Box Renda Extra com Estratégia"
        />
      </div>
    );
  }
  ...
  return (
    <button
      aria-label={
        hasYoutube
          ? "Reproduzir vídeo de apresentação"
    ...
    >
      <ResponsiveImage
        alt="Capa do vídeo de apresentação do box"
          ...
          <span>
            <strong className="block text-base font-black sm:text-xl">
              {hasYoutube
                ...
                : "Adicione aqui o vídeo de apresentação do seu produto."}
            </strong>
            <span className="mt-1 block text-sm text-white/80">
              {hasYoutube
                ? "O vídeo começa somente depois do seu clique."
