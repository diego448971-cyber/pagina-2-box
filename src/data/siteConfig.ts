...
export const siteConfig = {
  ...
  promotionalPrice: "R$ 14,90",
  paymentInfo: "Pagamento único. Produto 100% digital.",
  paymentMethods: ["Pix", "Cartão de crédito", "Boleto, quando disponível no checkout"],
  checkoutUrl: "https://pay.kiwify.com.br/ycd2ZYE",
  whatsappNumber: "5598999120388",
  whatsappMessage:
    "Olá! Vim pela página do Box Renda Extra com Estratégia e gostaria de mais informações.",
  youtubeVideoId: "",
  localVideoSrc: "/videos/vsl-placeholder.mp4",
  videoPoster: "/images/vsl-poster.png",
  instagramUrl: "https://www.instagram.com/renda.extracomestrategia/",
  facebookUrl: "https://www.facebook.com/profile.php?id=61590479477619",
